...
// This file defines the available pricing tiers and their features
...
export const PRICING_TIERS: Record<PricingTier, TierConfig> = {
  free: {
    ...
    features: [
      {
        sr: 'Do 10 slika po gostu',
        en: 'Up to 10 images per guest'
      },
      {
        sr: 'QR kod za pristup',
        en: 'QR code access'
      },
      {
        sr: 'Galerija fotografija',
        en: 'Photo gallery'
      },
      {
        sr: 'Preuzimanje svih slika',
  ...
  basic: {
    ...
    features: [
      {
        sr: 'Do 25 slika po gostu',
        en: 'Up to 25 images per guest'
      },
      {
        sr: 'Prilagođen QR kod',
        en: 'Custom QR code'
      },
      {
        sr: 'Galerija fotografija',
  ...
  premium: {
    ...
    features: [
      {
        sr: 'Do 50 slika po gostu',
        en: 'Up to 50 images per guest'
      },
      {
        sr: 'Prilagođen brending',
        en: 'Custom branding'
      },
      {
        sr: 'Napredni QR kod',
  ...
  unlimited: {
    ...
    price: 5999, // 59.99 EUR
    features: [
      {
        sr: 'Neograničeno slika po gostu',
        en: 'Unlimited images per guest'
      },
      {
        sr: 'Potpuna prilagodljivost',
        en: 'Full customization'
      },
      {
        sr: 'White-label opcija',
        en: 'White-label option'
      },
      {
        sr: 'Sve premium funkcije',
        en: 'All premium features'
      },
      {
        sr: 'Dedicirana podrška',

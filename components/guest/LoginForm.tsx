...
export function LoginForm() {
  ...
  return (
    <Card className="bg-card border-2 border-primary rounded-xl shadow px-6 py-8">
      <CardHeader>
        <CardTitle className="text-center text-primary text-2xl font-serif font-bold mb-2">Prijava</CardTitle>
      </CardHeader>
      <CardContent>
        <Form {...form}>

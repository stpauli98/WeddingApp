  ...
  return (
    <div className="max-w-xl mx-auto p-6 bg-white rounded-xl shadow-md border border-[hsl(var(--lp-accent))]/20 flex flex-col gap-5">
      <div className="flex items-center gap-4 border-b border-[hsl(var(--lp-accent))]/10 pb-4">
        ...
        <div>
          <h3 className="text-xl font-bold text-[hsl(var(--lp-text))]">Vaš vjenčani album</h3>
          <p className="text-sm text-[hsl(var(--lp-muted-foreground))]">Upravljajte uspomenama s vašeg posebnog dana</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        <div className="flex flex-col gap-3 p-4 bg-[hsl(var(--lp-muted))]/10 rounded-lg border border-[hsl(var(--lp-accent))]/20 hover:shadow-md transition-shadow">
          <div className="flex items-center gap-2">
            ...
            <h4 className="font-semibold text-[hsl(var(--lp-text))]">Galerija uspomena</h4>
          </div>
        ...
        <div className="flex flex-col gap-3 p-4 bg-[hsl(var(--lp-muted))]/10 rounded-lg border border-[hsl(var(--lp-accent))]/20 hover:shadow-md transition-shadow">
          <div className="flex items-center gap-2">
            ...
            <h4 className="font-semibold text-[hsl(var(--lp-text))]">Čestitke i poruke</h4>
          </div>
          <p className="text-sm text-[hsl(var(--lp-muted-foreground))]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        <div className="flex flex-col gap-3 p-4 bg-[hsl(var(--lp-muted))]/10 rounded-lg border border-[hsl(var(--lp-accent))]/20 hover:shadow-md transition-shadow">
          <div className="flex items-center gap-2">
            ...
            <h4 className="font-semibold text-[hsl(var(--lp-text))]">QR kod za goste</h4>
          </div>
          <p className="text-sm text-[hsl(var(--lp-muted-foreground))]">
        ...
        <div className="flex flex-col gap-3 p-4 bg-[hsl(var(--lp-muted))]/10 rounded-lg border border-[hsl(var(--lp-accent))]/20 hover:shadow-md transition-shadow">
          <div className="flex items-center gap-2">
            ...
            <h4 className="font-semibold text-[hsl(var(--lp-text))]">Vaša jedinstvena poveznica</h4>
          </div>
          <p className="text-sm text-[hsl(var(--lp-muted-foreground))]">
      ...
      <div className="mt-2 p-4 bg-gradient-to-r from-[hsl(var(--lp-muted))]/10 to-[hsl(var(--lp-accent))]/10 rounded-lg border border-[hsl(var(--lp-accent))]/20">
        <div className="flex items-center gap-3 mb-3">
          ...
          <h4 className="font-semibold text-[hsl(var(--lp-text))]">Trebate pomoć?</h4>
        </div>
      ...
      <div className="flex items-center justify-center gap-2 mt-1">
        ...
        <p className="text-xs text-[hsl(var(--lp-muted-foreground))]">Vaše uspomene su sigurne i privatne</p>
      </div>
    </div>
  );
};

...
const DashboardAnalytics: React.FC<DashboardAnalyticsProps> = ({ guests }) => {
  ...
  const topGuestName = topGuest && topGuest.images.length > 0 ? `${topGuest.firstName} ${topGuest.lastName}` : t('admin.dashboard.stats.noData');
  ...
  return (
    <div className="rounded-lg border border-[hsl(var(--lp-accent))]/20 p-8 bg-white/70 flex flex-col items-center gap-6">
      <h3 className="text-2xl font-bold text-[hsl(var(--lp-primary))] mb-2 flex items-center gap-2">
        <span className="text-3xl" role="img" aria-label="Statistika">📊</span> {t('admin.dashboard.stats.title')}
      </h3>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
        ...
        <div className="flex flex-col items-center bg-[hsl(var(--lp-muted))]/30 rounded-lg p-4 shadow-sm border border-[hsl(var(--lp-accent))]/20">
          ...
          <span className="text-xs text-[hsl(var(--lp-muted-foreground))]">{t('admin.dashboard.stats.totalGuests')}</span>
        </div>
        {/* Gostiju sa slikama */}
        <div className="flex flex-col items-center bg-[hsl(var(--lp-muted))]/30 rounded-lg p-4 shadow-sm border border-[hsl(var(--lp-accent))]/20">
          ...
          <span className="text-xs text-[hsl(var(--lp-muted-foreground))]">{t('admin.dashboard.stats.guestsWithImages')}</span>
        </div>
        {/* Ukupno slika */}
        <div className="flex flex-col items-center bg-[hsl(var(--lp-muted))]/30 rounded-lg p-4 shadow-sm border border-[hsl(var(--lp-accent))]/20">
          ...
          <span className="text-xs text-[hsl(var(--lp-muted-foreground))]">{t('admin.dashboard.stats.totalImages')}</span>
        </div>
        ...
        <div className="flex flex-col items-center bg-[hsl(var(--lp-muted))]/30 rounded-lg p-4 shadow-sm border border-[hsl(var(--lp-accent))]/20">
          ...
          <span className="text-xs text-[hsl(var(--lp-muted-foreground))]">{t('admin.dashboard.stats.avgImagesPerGuest')}</span>
        </div>
        {/* Gostiju sa porukom */}
        <div className="flex flex-col items-center bg-[hsl(var(--lp-muted))]/30 rounded-lg p-4 shadow-sm border border-[hsl(var(--lp-accent))]/20">
          ...
          <span className="text-xs text-[hsl(var(--lp-muted-foreground))]">{t('admin.dashboard.stats.guestsWithMessage')}</span>
        </div>
        {/* Najaktivniji gost */}
        <div className="flex flex-col items-center bg-[hsl(var(--lp-muted))]/30 rounded-lg p-4 shadow-sm border border-[hsl(var(--lp-accent))]/20">
          ...
          <span className="text-xs text-[hsl(var(--lp-muted-foreground))]">{t('admin.dashboard.stats.topGuest')}</span>
        </div>
      </div>
    </div>
  );

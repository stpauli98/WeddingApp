          ...
          <div className="flex flex-col md:flex-row justify-between gap-8 mb-8">
            ...
            <div className="flex flex-col sm:flex-row gap-6 sm:gap-10">
              ...
              <div className="flex gap-4 items-start">
                ...
                <a href="https://www.tiktok.com/@nextpixel.dev" target="_blank" rel="noopener noreferrer" className="text-lp-muted-foreground hover:text-lp-accent transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-lp-primary rounded" aria-label="TikTok">

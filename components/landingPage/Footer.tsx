      ...
      <AnimatePresence>
        {showScrollTop && (
          <motion.button
            ...
            className="fixed bottom-6 right-6 p-3 rounded-full bg-lp-primary text-white shadow-lg hover:bg-lp-primary/90 z-40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-lp-primary"

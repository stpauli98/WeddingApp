...
export default function DevNotice() {
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-white/95 backdrop-blur-sm">
      <div className="max-w-md w-full bg-white border-2 border-[#E2C275] rounded-2xl p-10 shadow-2xl flex flex-col items-center">
        <span className="text-3xl font-bold text-[#E2C275] mb-4">⚠️</span>
